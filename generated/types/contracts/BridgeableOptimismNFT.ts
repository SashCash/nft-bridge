...
export interface BridgeableOptimismNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface BridgeableOptimismNFT extends BaseContract {
  connect(runner?: ContractRunner | null): BridgeableOptimismNFT;
  waitForDeployment(): Promise<this>;

  interface: BridgeableOptimismNFTInterface;
