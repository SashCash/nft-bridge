...
export interface BridgeableArbitrumNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "allowOpenMint",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setAllowOpenMint",
    values: [boolean]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "tokenIdToDeposited",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface BridgeableArbitrumNFT extends BaseContract {
  connect(runner?: ContractRunner | null): BridgeableArbitrumNFT;
  waitForDeployment(): Promise<this>;

  interface: BridgeableArbitrumNFTInterface;
  ...
  allowOpenMint: TypedContractMethod<[], [boolean], "view">;
  ...
  setAllowOpenMint: TypedContractMethod<
    [_allowOpenMint: boolean],
    [void],
    "nonpayable"
  >;
  ...
  tokenIdToDeposited: TypedContractMethod<
    [arg0: BigNumberish],
    [boolean],
    "view"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "setAllowOpenMint"
  ): TypedContractMethod<[_allowOpenMint: boolean], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "tokenIdToDeposited"
